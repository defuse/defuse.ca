...
<ul>
    <li><b>Space, Time, and Motion (Sean Carroll)</b></li>
...
<ul>
    <li><b>The Wisdom of Insecurity (Alan Watts)</b></li>
...
<ul>
    <li>Why Buddhism Is True (Robert Wright)</li>
    <li><b>Why Evolution Is True (Jerry A. Coyne)</b></li>
...
<ul>
   ...
   <li><b>Cryptography Engineering</b></li>
   <li>Understanding Cryptography (Paar, Pelzl)</li>
   <li>Applied Cryptography (Schneier)</li>
   <li>Cryptography Theory and Practice (Stinson)</li>
   <li>Seven Deadliest Web Application Attacks</li>
   <li>Numerical Methods Using Matlab</li>
   <li>Essential PHP Security</li>
   <li>Practical Lock Picking</li>
   <li>Computability and Logic (Boolos)</li>
   <li>Writing for Computer Science</li>
   <li>Discrete Mathematics with Applications</li>
   <li><b>The Ruby Programming Language</b></li>
   <li>C++ For Dummies</li>
   <li>Understanding the Linux Kernel</li>
   <li>Hacking For Dummies</li>
   <li>Networking For Dummies</li>
   <li>Ghost in the wires (Mitnick)</li>
   <li>The art of deception (Mitnick)</li>
   <li>Peter Norton's Inside the PC</li>
   <li><b>The C Programming Language (K&R)</b></li>
   <li>HTML, XTHML, &amp; CSS (Castro)</li>
   <li>SPARC Architecture, Assembly Language Programming, and C</li>
   <li>Statistics (Freedman, Pisani, Purves)</li>
   <li><b>HACKING - The Art of Exploitation</b></li>
...
<ul>
    <li>Against Self-Location (Emily Adlam)</li>
...
<ul>
    <li><b>PIR with compressed queries and amortized query processing (Sebastian Angel et al.)</b></li>
...
<ul>
    ...
    <li><b>Memory Deduplication as a Threat to the Guest OS (Kuniyasu Suzaki et al.)</b></li>
    <li>An Experience Report on Extracting and Viewing Memory Events via Wireshark (Sarah Laing et al.)</li>
...
<ul>
    <li>RSA Key Extraction via Low-Bandwidth Acoustic Cryptanalysis (Daniel Genkin et al.)</li>
...
<ul>
    <li>Mental Causation on the Stanford Encyclopedia of Philosophy</li>
