...
<div style="border: solid blue 1px; background-color: #DDDDFF; padding: 10px;">
<strong>Note:</strong>
This is is an old version of the EncFS audit report, which is made available for
transparency. You should read the <a href="/audits/encfs.htm">new EncFS audit
report</a> instead.
</div>
