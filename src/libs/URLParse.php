...
class URLParse
{
    ...
    private static $DEFAULT_META_DESC = "Defuse Cyber-Security. Home of PIE Bin, TRENT, and more...";
    ...
    private static $PAGE_INFO = array(
            ...
            "resume" =>     array(
                    P_FILE => "resume.html",
                    P_TITL => "My Resume - Defuse Cyber-Security",
                    P_METD => "Defuse Cyber-Security Resume",
                    P_METK => "defuse cyber security, resume"
                    ),          
            "vimrc" =>      array(     
                    P_FILE => "vimrc.php",
                    P_TITL => "My .vimrc - Defuse Cyber-Security",
            ...
            "wordlists" =>  array(      
                    ...
                    P_TITL => "Password Cracking Wordlists - Defuse Cyber-Security",
            ...
            "projects" =>   array(      
                    ...
                    P_TITL => "Defuse Cyber-Security's Projects",
                    P_METD => "All of Defuse Cyber-Security's projects.",
                    P_METK => "security, computer security, projects",
                    ),          
            "php-hit-counter" => array( 
                    P_FILE => "projects/php-hit-counter.html",
                    P_TITL => "PHP & MySQL Unique Hit Count Tracker - Defuse Cyber-Security",
            ...
            "helloworld-cms" => array(
                    ...
                    P_TITL => "Secure and Light CMS for PHP - Defuse Cyber-Security",
            ...
            "passwordbolt" => array(
                    ...
                    P_TITL => "Password Bolt Password Manager - Defuse Cyber-Security",
            ...
            "bitcannon" =>  array(
                    ...
                    P_TITL => "BitCannon - The cross-platform, fast, secure, encrypted internet file transfer program for Windows, Macintosh, and Linux - Defuse Cyber-Security",
            ...
            "bitcannon-cryptography" => array(
                    ...
                    P_TITL => "BitCannon - Cryptographic Protocol Description - Defuse Cyber-Security",
            ...
            "ip-to-location" => array(
                    ...
                    P_TITL => "IP Address To Location (Country, City) - Defuse Cyber-Security",
            ...
            "web-server-scan" => array(
                    ...
                    P_TITL => "Web Server Security Scan - Defuse Cyber-Security",
            ...
            "webdevelopment" => array(
                    ...
                    P_TITL => "Custom Web Design and Development - Defuse Cyber-Security",
                    P_METD => "Custom web software development.",
                    ),
            "services" => array(
                    P_FILE => "services/services.html",
                    P_TITL => "Defuse Cyber-Security's Services",
                    P_METD => "Defuse Cyber-Security's Services.",
                    ),
            "peerreview" => array(
                    P_FILE => "services/peerreview.html",
                    P_TITL => "Peer Review and Security Testing Service - Defuse Cyber-Security",
            ...
            "trustedthirdparty" => array(
                    ...
                    P_TITL => "TRENT - FREE Third party Drawing Service - Defuse Cyber-Security",
            ...
            "trent-source" => array(
                    ...
                    P_TITL => "TRENT Source Code - Defuse Cyber-Security",
                    P_METD => "TRENT, the trusted random number generator for contests and drawings.",
                    P_METK => "contest drawing, third party, trusted, lottory, trent, random number generator",
                    ),
            "contact" => array(
            ...
            "race-conditions-in-web-applications" => array(
                    ...
                    P_TITL => "Practical Race Condition (TOCTTOU) Vulnerabilities in Web Applications - Defuse Cyber-Security",
            ...
            "choosing-good-passwords-longer-is-better" => array(
                    ...
                    P_TITL => "How to Pick a Good Password - Longer is Better - Defuse Cyber-Security",
            ...
            "ssl-fundamental-flaw-fix" => array(
                    ...
                    P_TITL => "Fixing the Flaw in the SSL Certificate Authority Architecture - Defuse Cyber-Security",
            ...
            "internetdangers" => array(
                    ...
                    P_TITL => "Dangers of the Internet - Defuse Cyber-Security",
                    P_METD => "Dangers of the Internet, an explanation of the dangers you face online.",
                    ),
            "softwaresecurity" => array(
                    P_FILE => "research/softwaresecurity.html",
                    P_TITL => "Software Security - Bypassing KeyScrambler and Avira - Defuse Cyber-Security",
            ...
            "web-application-security" => array(
                    ...
                    P_TITL => "Web Application Security - Defuse Cyber-Security",
            ...
            "research" => array(
                    ...
                    P_TITL => "Defuse Cyber-Security's Research",
                    P_METD => "Research projects by Defuse Cyber-Security",
                    ),
            "cryptographyunderattack" => array(
                    P_FILE => "research/cryptographyunderattack.html",
                    P_TITL => "Cryptography Under Attack - Defuse Cyber-Security",
                    P_METD => "Cryptography under attack essay.",
                    ),
            "passwordinsecurity" => array(
                    P_FILE => "research/passwordinsecurity.html",
                    P_TITL => "Are Passwords Secure? - Defuse Cyber-Security",
            ...
            "asuskeyboarddefect" => array(
                    ...
                    P_TITL => "ASUS G50 G51 Keyboard Problem: Backspace, P, and 1 keys don't work. - Defuse Cyber-Security",
            ...
            "software" => array(
                    ...
                    P_TITL => "Defuse Cyber-Security's Software",
                    P_METD => "Software created by Defuse Cyber-Security",
                    ),
            "winrrng" => array(
                    P_FILE => "software/winrrng.html",
                    P_TITL => "Real Random Number Generator for Windows - Defuse Cyber-Security",
                    P_METD => "A real random number generator for Windows",
                    ),
            "textractor" => array(
                    P_FILE => "software/textractor.html",
                    P_TITL => "Textractor - A tool for extracting words from large binary files - Defuse Cyber-Security",
            ...
            "dotnetbenchmark" => array(
                    ...
                    P_TITL => "Benchmark Tool for the .NET Framework - Defuse Cyber-Security",
                    P_METD => "A benchmark tool for the .NET Framework",
                    P_METK => "dot net framework, benchmark",
                    ),
            "eotp" => array(
                    P_FILE => "research/eotp.html",
                    P_TITL => "Encrypting One Time Passwords System - Defuse Cyber-Security",
            ...
            "password-policy-statistics" => array(
                    ...
                    P_TITL => "Password Policy Statistics - Defuse Cyber-Security",
            ...
            "gpucrack" => array(
                    ...
                    P_TITL => "CUDA Salted MD5 GPU Cracker Source Code - Defuse Cyber-Security",
            ...
            "force-print-background" => array(
                    ...
                    P_TITL => "HTML/CSS Force Printing of Background Color - Defuse Cyber-Security",
            ...
            "waterfall" => array(
                    ...
                    P_TITL => "Waterfall Password Cracking Algorithm - Defuse Cyber-Security",
            ...
            "csharpthreadlibrary" => array(
                    ...
                    P_TITL => "PolyThread - C# Thread Library - Defuse Cyber-Security",
            ...
            "simppsk" => array(
                    ...
                    P_TITL => "SimpPSK - A simple pre-shared key authentication and session key exchange implementation - Defuse Cyber-Security",
                    P_METK => "pre-shared key, key exchange, library, c++, c plus plus",
                    ),
            "checksums" => array(
                    P_FILE => "services/checksums.php",
                    P_TITL => "Online Text and File Hash Calculator - MD5, SHA1, SHA256, SHA512, WHIRLPOOL Hash Calculator - Defuse Cyber-Security",
            ...
            "html-sanitize" => array(
                    ...
                    P_TITL => "Online HTML Sanitizer Tool - htmlspecialchars - Defuse Cyber-Security",
            ...
            "pdfcleaner" => array(
                    ...
                    P_TITL => "PDF Exploit Sanitizer and Cleaner - Remove exploits from PDF files - Defuse Cyber-Security",
            ...
            "tics" => array(
                    ...
                    P_TITL => "TICS - Time Intensive Computer Solvable CAPTCHA Alternative - Defuse Cyber-Security",
                    ),
            "browserui" => array(
                    P_FILE => "research/browserui.html",
                    P_TITL => "Redesigning the Web Browser GUI - Defuse Cyber-Security",
                    P_METD => "The web browser needs a redesign..",
                    ),
            "flashsupercomputer" => array(
                    P_FILE => "research/flashsupercomputer.html",
                    P_TITL => "Building a Distributed Supercomputer with Flash - Defuse Cyber-Security",
            ...
            "filesystem-events-ntfs-permissions" => array(
                    ...
                    P_TITL => "File System Events Disclose NTFS Protected Folder Contents - Defuse Cyber-Security",
                    P_METD => "Obtain list of files in folder protected with NTFS permissions via filesystem events",
                    ),
            "pastebin" => array(
                    P_FILE => "services/pastebin.html",
                    P_TITL => "Encrypted Pastebin - Keep your data private and secure! - Defuse Cyber-Security",
