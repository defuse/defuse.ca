...
?>
		...
		Move credit <a href="addbalance.php">into</a> | <a href="#">out of</a> my Stubshare account.<br />
		Recent <a href="userhome.php?tbl=purchases">purchases</a>.
		</div>
		...
		<div class="box">
			<?php
				...
				echo "<a href=\"userhome.php\">$rebold Featured$reboldEnd</a> | <a href=\"userhome.php?tbl=stubs\">$stubsBold My Recent Stubs$stubsBoldEnd</a> <!-- | <a href=\"userhome.php?tbl=purchases\"> $pBold My Recent Purchases $pBoldEnd</a> | <a href=\"userhome.php?tbl=unshared\">$unsharedBold Unshared Purchases$unsharedBoldEnd</a>-->"
			?>
			...
			?>
				...
				<?php
					...
					while($q && $stub = mysql_fetch_array($q))
					{
						...
						/*$disp = "<tr style=\"background-color:#a9bbde;\"><td style=\"width:62px;height:100px; margin-bottom:30px;\"><img src=\"prodimg.php?id=$productID\" style=\"float:left; width:60px; height:60px;\"/></td><td>$prodName</td><td>$prodDesc</td><td>$stubHTML</td><td>$share</td></tr>";*/
						$disp = "<div style=\"height: 100px; margin-bottom:20px; background-color:#a9bbde;\">
							<table>
							<tr>
								<td><img src=\"prodimg.php?id=$productID\" style=\"float:left; width:100px; height:100px;\"/></td>
								<td style=\"width:400px;\"><b>$prodName</b><br />$prodDesc</td>
								<td>$stubHTML</td>
								<td>$share</td>
							</tr>
							</table>
