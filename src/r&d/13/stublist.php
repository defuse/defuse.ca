...
<div class="box">
			...
			<tr><th>Price</th><th>Title</th><th>Source</th><th>Format</th><th>Coupon</th><th>Sales</th><th>Share</th></tr>
			<?php
			...
			while($ary = mysql_fetch_array($q))
			{
				...
				echo "<tr><td>$stub</td><td>$linkbefore$product$linkafter</td><td>$owner</td><td>$formatName</td><td>$$coupon</td><td>$sales</td><td><a href=\"" . WEBROOT . "stubcode.php?id=$stubID\">Get&nbsp;Link</a></td><td>$facebook</td><td>$twitter</td></tr>";
			}
