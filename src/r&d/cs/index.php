...
<div id="header">
	...
	<div id="header_inner" class="fluid">
		...
		<div id="menu">
			<ul>
				<li><a href="index.php" class="active">Crack</a></li>
				<li><a href="cracking-services.html">Advanced Services</a></li>
				<li><a href="http://ossbox.com/salted-password-hashing-doing-it-properly.htm" target="_blank">Hashing Security</a></li>
	...
	<div id="main_inner" class="fluid">
		...
		<div id="primaryContent_columnless">
			...
			<div id="columnA_columnless">
				...
				<p>
				Crackstation uses massive pre-computed lookup tables to crack password hashes. These tables store a mapping between the hash of a password, and the correct password for that hash. The hash values are indexed so that it is possible to quickly search the database for a given hash. If the hash is present in the database, the password can be recovered in less only a fraction of a second. This cracking method only works for "unsalted" hashes. For information on password hashing systems that are not vulnerable to pre-computed lookup tables, see our <a href="http://ossbox.com/salted-password-hashing-doing-it-properly.htm" target="_blank">hashing security page</a>.
				</p>
...
<div id="footer" class="fluid">
	An <a href="http://ossbox.com/">OSSBox</a> and <a href="http://blizma.com/">Blizma</a> Project. Copyright &copy; 2011. All rights reserved. Design by <a href="http://www.nodethirtythree.com/" rel="nofollow" >NodeThirtyThree Design</a>.
</div>
