...
?>
		...
		<div class="box">
			<a href="userhome.php">Recent Purchases</a> | <a href="userhome.php?tbl=stubs">My Stubs</a> | <a href="userhome.php?tbl=unshared">Unshared Purchases</a>
			<?php
			if(!isset($_GET['tbl']) || $_GET['tbl'] == "recent")
			{
			?>
