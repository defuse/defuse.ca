...
{
	echo "You are using the public, free scanner. Your file may be distributed unless you pay for the service.";
}
else
{
	echo "You are logged in as a paying user. Your file will not be distributed.";
}
?>
