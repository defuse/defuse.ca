...
class StubShare
{
	...
	public static function AddProduct($username, $productName, $description, $price, $url)
	{
		...
		mysql_query("INSERT INTO products (owner, name, description, url, price) VALUES('$userID', '$safe_name', '$safe_desc', '$safe_url', '$safe_price')");
		echo mysql_error();
	}
