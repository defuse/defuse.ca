...
{
	?>
	<b>You own this product.</b> <a href="<?php echo $url; ?>">Click here to view the product</a>
	<?
}
else
{
	...
	<table style="display:inline;"><tr><td><?php echo StubShare::GetFacebookImageLink($stubID); echo "</td></tr><tr><td>"; echo StubShare::GetTwitterImageLink($stubID); ?></td></tr></table>
	</form>
