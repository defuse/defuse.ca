...
?>
		...
		<h1>My Account</h1>
			...
			?>
				...
				<table class="scrolltable"><tr>
				<?php
				$q = mysql_query("SELECT * FROM stubs WHERE owner!='$userid' ORDER BY id DESC");
				$count = 0;
				while($count < 10 && $q && $stub = mysql_fetch_array($q))
				{
					$stubID = $stub['id'];
					...
					?>
					<td>
						<?php echo "<center><img src=\"prodimg.php?id=$productID\" style=\"width:100px; height:100px;\"/></center>"; ?>
						<br />
						<h2><?php echo $prodName; ?></h2>
						<div class="scrolldesc"><?php echo $prodDesc; ?></div>	<br />
						<?php echo $stubHTML; ?>
						<table class="sharetable"><tr><td><?php echo $share; ?></td></tr></table>
					</td>
					<?
					$count++;
				}
			...
			?>
				...
				<tr><th>Price</th><th>Title</th><th>Source</th><th>Format</th><th>Share</th></tr>
				<?php
			...
			?>
				<div class="whitebox">
				<table class="infotable">
				<tr><th>Paid</th><th>Title</th><th>Source</th><th>Format</th><th>Share</th></tr>
				<?php
