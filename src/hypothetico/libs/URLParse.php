...
class URLParse
{
    ...
    private static $PAGE_INFO = array(
            ...
            "issues" => array(
                P_FILE => "issues.php",
                P_TITL => "Hypothetico | Hypothetico Issues",
                P_METD => "All hypothetico magazine issues.",
                P_METK => "hypothetico, magazine, issues, volumes",
                ),
            "submit" => array(
                P_FILE => "submit.php",
                P_TITL => "Hypothetico | Submit to Hypothetico",
                P_METD => "Submit your work to Hypothetico magazine.",
                P_METK => "hypothetico, magazine, submissions, submit",
                ),
            );
